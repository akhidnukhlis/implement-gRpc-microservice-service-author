...
const canceledMessage = "pq: canceling statement due to author request"

// ParsePostgresSQLError converts the error from pq driver using postgresSQL error codes.
...
// ParseMysqlSQLError converts the error from mysql driver using error codes.
